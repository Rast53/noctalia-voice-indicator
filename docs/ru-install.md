...
- `F11` — длинная диктовка: нажали один раз для старта; запись сама остановится после выбранной паузы тишины, либо можно нажать F11 ещё раз вручную. По умолчанию: 10 секунд. Во время паузы индикатор показывает обратный отсчёт.
