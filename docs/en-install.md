...
- `F11` — long dictation: press once to start; it auto-stops after the configured silence pause, or press F11 again to stop manually. Default pause: 10 seconds. The bar shows a countdown during the pause.
